...
public class DrugFormInfoAction implements IAction {
	...
	public String process(HttpServletRequest request,
		...
		try {
			...
			String line1 = request.getParameter("line");
			
			String parameter = "&numOfRows=10";
			
			if(color != null && form != null && line1 != null){
				form = URLEncoder.encode(form, "UTF-8");
				color = URLEncoder.encode(color, "UTF-8");
				line1 = URLEncoder.encode(line1, "UTF-8");
				
				parameter = "&drug_shape=" + form + "&color_class1=" + color + "&line_front=" + line1;
			}
