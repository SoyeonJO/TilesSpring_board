...
public class DrugInfoAction implements IAction {
	...
	public String process(HttpServletRequest request,
		...
		try {
			...
			String itemSeq = request.getParameter("item_seq");
			
			itemSeq = URLEncoder.encode(itemSeq, "UTF-8");
			...
			String parameter = "&item_seq=" + itemSeq;
