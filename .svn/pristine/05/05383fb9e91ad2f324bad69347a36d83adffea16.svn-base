		...
		<ul id="side-menu" class="nav">
			...
			<li>
			 ...
			 <c:if test="${!empty LOGIN_ADMININFO }">
				<li>
					<a href="${pageContext.request.contextPath }/admin/mypage/mypage.do">
