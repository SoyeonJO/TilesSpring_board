...
//     </ul>
		...
		if((this.currentPage - 1) == 0){
			...
			this.pagingHTMLS.append("<li><a href='" + requestURI + "?" + otherParams + "currentPage=" + (this.currentPage - 1) + "'>&laquo;</a></li>");
		}
		...
		for(int i=this.startPage; i<=this.endPage; i++){
			if(this.currentPage == i){
				...
				this.pagingHTMLS.append("<li><a href='" + requestURI + "?" + otherParams + "currentPage=" + i + "'>" + i + "</a></li>");
			}
		}
		
		// 다음
		if(this.currentPage < this.totalPage){
			this.pagingHTMLS.append("<li><a href='" + requestURI + "?" + otherParams + "currentPage=" + (this.currentPage + 1) + "'>&raquo;</a></li>");
		}else{
