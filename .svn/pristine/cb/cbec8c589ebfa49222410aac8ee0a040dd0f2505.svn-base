...
<body>
	...
	<div class="panel panel-black">
	    ...
	    <div class="panel-body pan">
	        <form action="${pageContext.request.contextPath}/user/mypage/passCheck.do" method="post" class="form-horizontal">
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-md-9">
	                    <div class="input-icon right">
	                        ...
	                        <input id="myid" name="mem_id" value="${LOGIN_MEMBERINFO.mem_id }" type="hidden" />
	                	</div>
	                </div>
	            </div>
	        </div>
