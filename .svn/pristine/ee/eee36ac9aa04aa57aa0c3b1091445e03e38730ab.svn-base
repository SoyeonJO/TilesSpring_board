...
<div id="header-topbar-option" class="page-header-topbar">
	<nav id="topbar" role="navigation" style="margin-bottom: 0;" data-step="3" 
		...
		<div class="navbar-header">
			...
			<a id="logo" href="/user/drug/searchDrugName.do" class="navbar-brand">
				<span class="logo-text text-white" style="font-size: 25px;">DRUG STORE</span>
			</a>
		</div>
...
<!-- 			</form> -->
			...
			<c:if test="${empty LOGIN_MEMBERINFO }">
				<div class="loginForm nav navbar navbar-top-links navbar-right"
					...
					<ul>
						<li class="dropdown">
							<label for="inputName" class="control-label text-white">아이디 :</label>
					        <input type="text" 	name="mem_id" placeholder="아이디를 입력해주세요."  class="text-yellow" />
					    </li>
					    <li>&nbsp;&nbsp;</li>
					    <li class="dropdown">
						    <label for="inputName" class="control-label text-white">패스워드 :</label>
				        ...
				        <li class="dropdown">
				        	...
				        	<button type="button" class="btn btn-jeongmin btn-sm" id="memberRegistBtn">회원가입</button>
					    </li>
				        <li class="dropdown">
				        	<button type="button" class="btn btn-jeongmin btn-sm" id="searchidpass">아이디/비번 찾기</button>
					    </li>
					</ul>	    
				</div>
			</c:if>
