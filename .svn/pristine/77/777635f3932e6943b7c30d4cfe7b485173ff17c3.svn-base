...
<body>
	<form action="">
		...
		<br>
		<div id="list" class="panel panel-green">
        	<div class="panel-heading">약국 정보 목록</div>
...
<script type="text/javascript">
			...
			$(function(){
				$.ajax({
					url : '/admin/drugstore/getSido.do',
					dataType : 'xml',
					type : 'get',
				...
				$('#sido').change(function(){
					...
					$.ajax({
						url : '/admin/drugstore/getGugun.do',
						dataType : 'xml',
						type : 'get',
						data : { 'sido' : sido },
						success : function(res){
				...
				$('#gugun').change(function(){
					...
					$.ajax({
						url : '/admin/drugstore/getDrugStore.do',
						dataType : 'xml',
						type : 'get',
						data : { 'sido' : sido,
								 'gugun' : gugun },
				...
				$('#body').on('click', '.drugstoretr', function(){
					...
					var iwContent = '<div style="padding:5px; color:blue; font-size:12px; font-weight:bold; text-align:center;">' + name + ' </div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
