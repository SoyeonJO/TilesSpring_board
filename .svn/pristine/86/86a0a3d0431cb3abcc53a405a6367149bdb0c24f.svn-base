...
<script>
	$(function(){
		...
		content = $('#news_content').val().trim();
			...
			$(this).append('<input type="hidden" name="news_mem_id" value="${LOGIN_ADMININFO.mem_id}"></input>');
			$(this).append('<input type="hidden" name="news_mem_name" value="${LOGIN_ADMININFO.mem_name}"></input>');
