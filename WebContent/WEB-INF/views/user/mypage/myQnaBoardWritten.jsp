	    ...
	    <div class="container-fluid">
	        ...
	        <div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse">
	            <ul class="nav navbar-nav">
	                <li><a href="${pageContext.request.contextPath }/user/mypage/myBoardWritten.do">자유게시판</a></li>
	                <li class="active"><a href="${pageContext.request.contextPath }/user/mypage/searchQnaBoard.do">QnA게시판</a></li>
	            </ul>
	            <form role="search" class="navbar-form navbar-right" method="GET" action="${pageContext.request.contextPath }/user/mypage/myQnaBoardWritten.do">
        ...
        <div class="panel-body">
            <table class="table table-hover-color">
                ...
                <c:if test="${!empty boardList }">
	                ...
	                <tr>
	                    <td id="rnum"><input type="hidden" id="no" value="${boardinfo.qa_no }"/>${boardinfo.rnum }</td>
	                    <td id="title">${boardinfo.qa_title }</td>
	                    <td id="date">${fn:substringBefore(boardinfo.qa_reg_date, ' ') }</td>
	                    <td id="hit">${boardinfo.qa_hit }</td>
	                </tr>
	                </c:forEach>
                </c:if>
<!--                 <tr> -->
